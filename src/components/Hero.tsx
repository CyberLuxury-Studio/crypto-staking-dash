...
export default function Hero() {
  return (
    <section className="pt-40 pb-20 px-6 text-center relative overflow-hidden min-h-[90vh] flex flex-col justify-center">
      ...
      >
        THE crypto staking dash <br/><span className="text-[#00FF41] underline decoration-[#FF003C] underline-offset-8">PROTOCOL.</span>
      </motion.h1>
      ...
      >
        Build a DeFi staking dashboard. Engineered for extreme data density and uncompromising security.
      </motion.p>
